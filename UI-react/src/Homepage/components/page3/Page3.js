	...
	render() {
	    return (
	    	<div className="page2">
	    		...
	    		<ReactSVG src="https://s3-eu-central-1.amazonaws.com/munlib/img/rendator.svg" className="statue_page3"/>

	    		<div className="rightdiv_page2">

	    			<div className="heading_rightdiv_page2">Documents related to the South American Continent</div>
	    			...
	    			<div className="content_rightdiv_page2">
	    				...
	    				<nav className="nav_content_rightdiv_page2">
	    					<div className="nav_inner" onClick={function(e){
								...
								document.getElementsByClassName("inner_content_rightdiv_page2")[1].style.display = "none";
	    					...
	    					<div className="nav_inner" onClick={function(e){
	    						...
	    						document.getElementsByClassName("page1")[0].style.marginTop = "-300vh";
								document.getElementsByClassName("bottom_nav")[0].style.marginTop = "-304%";
								document.getElementsByClassName("as1")[0].style.marginTop = "-300vh";
								document.getElementsByClassName("as2")[0].style.marginTop = "-300vh";
								document.getElementsByClassName("as3")[0].style.marginTop = "-300vh";
								document.getElementsByClassName("as3")[0].style.bottom = "300vh";
								document.getElementsByClassName("inner_content_rightdiv_page2")[1].style.display = "none";
								document.getElementsByClassName("inner_content_rightdiv_page2")[2].style.display = "block";
